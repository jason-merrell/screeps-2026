...
An accepted decision closes that service occurrence; it does not complete the recurring service definition. The definition remains Active until a separately governed closure or supersession criterion exists. This is an autonomous-system adaptation, not canonical human acceptance; the human authority chain remains issue #164. Operational room health is not DQI or PQI; complete EQVM roll-up remains issue #136.
