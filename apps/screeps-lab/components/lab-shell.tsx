  ...
  return (
    <div className="min-h-screen">
      <header className="lab-topbar sticky top-0 z-40 border-b border-white/8 bg-background/82 backdrop-blur-xl">
        <div className="mx-auto flex w-[min(1480px,calc(100vw-32px))] items-center justify-between gap-4 py-3">
          <a href="/" className="group flex items-center gap-3" aria-label="Screeps Lab home">
          ...
          <nav className="flex items-center gap-1 rounded-xl border border-white/8 bg-black/15 p-1" aria-label="Primary navigation">
            <a
              href="/"
              className={cn(
      ...
      <main className="mx-auto w-[min(1480px,calc(100vw-32px))] pb-16 pt-8 md:pt-10">
